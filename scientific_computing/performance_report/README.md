...
1. please also report within __Performance Analysis__ a summary of the performance data extracted from the report text file, as in the following example:
 ```
